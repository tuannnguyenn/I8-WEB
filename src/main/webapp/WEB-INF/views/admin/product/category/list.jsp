                                ...
                                <tr>
                                    ...
                                    <td class="clearfix">
                                        ...
                                        <ul class="list-operation fl-right">
                                            <li><a href="<c:url value="/EditCategoryProduct/${item.id}"/>" title="Sửa" class="edit"><i class="fa fa-pencil" aria-hidden="true"></i></a></li>
                                            <li><a href="<c:url value="/DeleteCategoryProduct/${item.id}"/>" title="Xóa" class="delete"><i class="fa fa-trash" aria-hidden="true"></i></a></li>
                                        </ul>
                                    </td>
                                    <td><span class="tbody-text">${item.slug}</span></td>

                                    <td><span class="tbody-text">${item.cat_id}</span></td>
